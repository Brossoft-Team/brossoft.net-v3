...
const Pricing = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-24  mx-48 text-white">

      <div className="flex flex-col border border-gray-800 rounded-2xl p-20 bg-gradient-to-tr from-[#000] to-[#1e1e1e] text-center">
